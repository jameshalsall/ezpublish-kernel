...
class FieldTypeNameableCollectionFactory extends ContainerAware
{
    ...
    public function registerNameableFieldType($nameableFieldTypeServiceId, $fieldTypeAlias)
    {
        ...
        $this->fieldTypes[$fieldTypeAlias] = function () use ($container, $nameableFieldTypeServiceId) {
    ...
    public function registerNonNameableFieldType($fieldTypeServiceId, $fieldTypeAlias)
    {
        ...
        $this->fieldTypes[$fieldTypeAlias] = function () use ($container, $fieldTypeServiceId) {
            return $container->get($fieldTypeServiceId);//@todo New NameableFieldTypeFallback($container->get($fieldTypeServiceId));
        };
    }
